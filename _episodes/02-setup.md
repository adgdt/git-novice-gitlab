...
For these lessons, we will be interacting with [GitLab](http://gitlab.ift.uam-csic.es/) and so the email address used should be the same as the one used when setting up your GitLab account.  
